---
title: Actualizar Reduced [REVISAR]
---

<!-- ABRE DATOS DEL MÉTODO -->
::: note Método para actualizar los datos de una persona de forma reducida.

**Nombre publicación:** PublicPersons.updateReduced
...
Nombre | Tipo | Comentarios
:--------- | :--------- | :---------
naturalPerson | SdtsBTPEWNaturalPerson | Datos de persona natural.
...
```json
{
  ...
  "Btoutreq": {
    ...
    "Hora": "18:55:47",
    "Numero": 13469370,
    "Servicio": "PublicPersons.updateReduced",
    "Requerimiento": "1",
    "Canal": "BTDIGITAL"
  }
}
