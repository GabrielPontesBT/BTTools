---
title: Obtener Tipos de Actividades
breadcrumb: false
pageInfo: false
toc: false
contributors: false
...
::: note Método para obtener los tipos de actividad.
Este servicio permite consultar el catálogo de tipos de actividad disponibles para personas.
...
:--------- | :----------- | :-----------
activityTypes | Array | Lista de tipos de actividad.
...
```json
curl -X POST \
  'http://btd-bantotal.eastus2.cloudapp.azure.com:4462/btdeveloper/servlet/com.dlya.bantotal.odwsbt_PublicPersons_v1?getActivityTypes' \
...
::: center
Los campos del tipo de dato estructurado activityType son los siguientes:
