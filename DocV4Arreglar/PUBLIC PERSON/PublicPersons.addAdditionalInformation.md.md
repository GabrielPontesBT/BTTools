---
title: Agregar Informacion Adicional
breadcrumb: false
pageInfo: false
toc: false
contributors: false
...
Este servicio permite registrar información adicional (custom fields) asociada a una persona existente.
...
```json
curl -X POST \
  'http://btd-bantotal.eastus2.cloudapp.azure.com:4462/btdeveloper/servlet/com.dlya.bantotal.odwsbt_PublicPersons_v1?addAdditionalInformation' \
