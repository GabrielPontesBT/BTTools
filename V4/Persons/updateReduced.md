...
::: note
Método para actualizar los datos de una persona de forma reducida.

**Nombre publicación:** PublicPersons.reduced

**Programa:** PublicAPI.BTPEPA0009

**Alcance:** Global

**Endpoint:** /public/Persons/v1/reduced
:::
...
```bash
curl -X PUT \
  '{{baseUrl}}/public/Persons/v1/reduced?personGUID=d742016d-f0fc-4fff-be0e-3ff1dd7015a4' \
  -H 'Device: {{device}}' \
  -H 'Usuario: {{usuario}}' \
