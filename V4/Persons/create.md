...
**Programa:** PublicAPI.BTPEPA0030

**Alcance:** Global

**Endpoint:** /public/Persons/v1/create
:::
...
:--------- | :--------- | :---------
naturalPerson | [naturalPerson](#naturalperson) | Datos de persona física.
...
```bash
curl -X POST \
  '{{baseUrl}}/public/Persons/v1/create' \
  -H 'Device: {{device}}' \
  -H 'Usuario: {{usuario}}' \
