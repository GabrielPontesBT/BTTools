---
title: Create Reduced
type: POST
---

<!-- ABRE DATOS DEL MÉTODO -->
::: note
Método para crear una persona de forma reducida.

**Nombre publicación:** PublicPersons.createReduced

**Programa:** PublicAPI.BTPEPA0008

**Alcance:** Global

**Endpoint:** /public/Persons/v1/createReduced
:::
...
:--------- | :--------- | :---------
naturalPerson | [naturalPerson](#naturalperson) | Datos de la persona física.
...
```bash
curl -X POST \
  '{{baseUrl}}/public/Persons/v1/createReduced' \
  -H 'Device: {{device}}' \
  -H 'Usuario: {{usuario}}' \
