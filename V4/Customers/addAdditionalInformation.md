...
::: note
Método para agregar información adicional a una contraparte.
...
**Endpoint:** /public/Customers/v1/addAdditionalInformation
:::
...
```bash
curl -X POST \
  '{{baseUrl}}/public/Customers/v1/addAdditionalInformation?counterpartyGUID=45399742-1326-4d8d-b7c8-10eb4cf976b0' \
  -H 'Device: {{device}}' \
  -H 'Usuario: {{usuario}}' \
