...
::: note
Método para eliminar la información adicional de una contraparte.
...
```bash
curl -X DELETE \
  '{{baseUrl}}/public/Customers/v1/additionalInformation?counterpartyGUID=45399742-1326-4d8d-b7c8-10eb4cf976b0&&customFieldId=Afición&customFieldCorrelative=1' \
  -H 'Device: {{device}}' \
  -H 'Usuario: {{usuario}}' \
