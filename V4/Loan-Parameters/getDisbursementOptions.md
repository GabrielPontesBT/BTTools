---
title: Get Disbursement Options
---

<!-- ABRE DATOS DEL MÉTODO -->
::: note Método para obtener un listado de las opciones de desembolso.

**Nombre publicación:** PublicLoanParameters.getDisbursementOptions
...
```json
{
  ...
  "Btoutreq": {
    ...
    "Hora": "17:36:14",
    "Numero": 13568709,
    "Servicio": "PublicLoanParameters.getDisbursementOptions",
    "Requerimiento": "1",
    "Canal": "BTDIGITAL"
  }
}
...
id | Short $<(Length: 3)>$ | Identificador de opción de desembolso.
:::
<!-- CIERRA SDT -->
