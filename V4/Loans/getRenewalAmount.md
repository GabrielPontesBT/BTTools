...
::: note
Método para obtener el monto de renovación.

**Nombre publicación:** PublicLoans.renewalAmount

**Programa:** PublicAPI.BTLOPA0015

**Alcance:** Global

**Endpoint:** /public/Loans/v1/renewalAmount
:::
...
```bash
curl -X GET \
  '{{baseUrl}}/public/Loans/v1/renewalAmount?counterpartyGUID=3a7f2d91-bc14-4e58-9f3a-d2c18b450e77&loanGUID=b84e1c60-73d2-4a91-8f5e-cf920a371d24&calculationDate=2026-06-19' \
  -H 'Device: {{device}}' \
  -H 'Usuario: {{usuario}}' \
