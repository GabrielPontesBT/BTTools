...
feeName | String $<(Length: 30)>$ | Descripción de comisión.
...
:--------- | :----------- | :-----------
amount | Double $<(Length: 18.2)>$ | Monto.
description | String $<(Length: 40)>$ | Descripción de seguro.
...
Description | String $<(Length: 30)>$ | Description de comisión.
FeeId | Int $<(Length: 5)>$ | Identificador de comisión.
...
Description | String $<(Length: 30)>$ | Descripción de seguro.
