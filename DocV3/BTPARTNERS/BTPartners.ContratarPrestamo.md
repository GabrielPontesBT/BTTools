...
operacionUId | Long | 
cuentaUId | Long | 
operacionAcreditacionUId	 | Long | 
operacionCobroUId | Long | 
...
```json
curl -X POST \
  'http://SQLSERVER1:8445/btdeveloper/servlet/com.dlya.bantotal.odwsbt_BTPartners?ContratarPrestamo' \
