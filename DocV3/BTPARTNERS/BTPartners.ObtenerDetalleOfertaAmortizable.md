---
title:  Obtener Detalle Oferta Amortizable
breadcrumb: false
pageInfo: false
toc: false
contributors: false
...
Nombre | Tipo | Comentarios
:--------- | :----------- | :-----------
sdtSimulacionOutput | SdtsBTSimulacionOutput | 
...
```json
curl -X POST \
  'http://SQLSERVER1:8445/btdeveloper/servlet/com.dlya.bantotal.odwsbt_BTPartners?ObtenerDetalleOfertaAmortizable' \
