...
```json
curl -X POST \
  'http://SQLSERVER1:8445/btdeveloper/servlet/com.dlya.bantotal.odwsbt_BTPartners?ObtenerMarcas' \
...
::: center
Los campos del tipo de dato estructurado sdtMarcas son los siguientes:
