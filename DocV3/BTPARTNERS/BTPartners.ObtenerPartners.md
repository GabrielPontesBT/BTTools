...
```json
curl -X POST \
  'http://SQLSERVER1:8445/btdeveloper/servlet/com.dlya.bantotal.odwsbt_BTPartners?ObtenerPartners' \
...
::: center
Los campos del tipo de dato estructurado sdtPartners son los siguientes:
